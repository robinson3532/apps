...
class MemoApp:
    ...
    def setup_ui(self):
        ...
        self.title_entry = UndoableEntry(title_frame, font=("Arial", 12))
    ...
    def open_search_replace(self):
        ...
        find_entry = UndoableEntry(dialog, textvariable=find_var, width=35, font=("Arial", 10))
        find_entry.pack(pady=5)
        find_entry.focus()
        
        tk.Label(dialog, text="置換:", font=("Arial", 10)).pack(pady=(10, 5))
        replace_var = tk.StringVar()
        replace_entry = UndoableEntry(dialog, textvariable=replace_var, width=35, font=("Arial", 10))
